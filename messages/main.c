...
static const char def_rc_service[] = "org.tizen.messages";
...
static const Ecore_Getopt options = {
	...
	"Phone Messages using oFono and EFL.",
	EINA_FALSE,
...
EAPI int elm_main(int argc, char **argv)
{
	...
	_log_domain = eina_log_domain_register("messages", NULL);
	if (_log_domain < 0)
	{
		EINA_LOG_CRIT("Could not create log domain 'messages'.");
		elm_shutdown();
		return EXIT_FAILURE;
	}
